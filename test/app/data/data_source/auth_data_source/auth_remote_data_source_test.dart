...
//
// @GenerateNiceMocks([MockSpec<AuthRemoteDataSource>(), MockSpec<Api>()])
// void main() {
//   final mockAuthRemoteDataSource = MockAuthRemoteDataSource();
//   final mockApi = MockApi();
//   final authRemoteDataSourceImpl = AuthRemoteDataSourceImpl(api: mockApi);
//
...
//         };
//         when(mockApi.post(uri, body: jsonEncode(body),headers: headers)).thenAnswer((e) async {
