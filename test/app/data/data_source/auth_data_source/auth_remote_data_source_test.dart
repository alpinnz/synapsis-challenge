...
void main() {
  ...
  final authRemoteDataSourceImpl = AuthRemoteDataSourceImpl(httpClient: mockHttpClient);
  ...
  group("Auth Remote Data Source Implementation", () {
    group("onLoginTabletUnit()", () {
      test('Status Code 200', () async {
        ...
        when(mockHttpClient.post(uri, body: jsonEncode(body),headers: headers)).thenAnswer((e) async {
