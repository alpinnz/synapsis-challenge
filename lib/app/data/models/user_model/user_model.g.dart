...
UserModel _$UserModelFromJson(Map<String, dynamic> json) => UserModel(
      ...
      lastPit: json['last_pit'],
      lastHauler: json['last_hauler'],
      lastLoader: json['last_loader'],
      lastLoadingPoint: json['last_loading_point'],
      lastDumpingPoint: json['last_dumping_point'],
      lastMaterial: json['last_material'],
