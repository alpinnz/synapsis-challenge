...
mixin _$DataState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FlutterError error) failed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(FlutterError error)? failed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailedImpl<T> extends _Failed<T> {
  const _$FailedImpl({required this.error}) : super._();
...
abstract class _Failed<T> extends DataState<T> {
  const factory _Failed({required final FlutterError error}) = _$FailedImpl<T>;
