...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/install.svg
  SvgGenImage get install => const SvgGenImage('assets/icons/install.svg');
  ...
  SvgGenImage get rock => const SvgGenImage('assets/icons/rock.svg');
  ...
  /// List of all assets
  List<SvgGenImage> get values => [chart, install, mail, menu, notification, pin, rock, send, settings, speed, target, time, voice, warning];
}
